...
public class ArrowTower extends DefenseUnit {
    ...
    public ArrowTower(int armor, int baseDamage){
        super.armor = ARMOR_ARROWTOWER + (PLUS_ARMOR_ARROWTOWER_BY_TECHNOLOGY * armor) * 1000/100;
        super.initialArmor = super.armor;
        super.baseDamage = BASE_DAMAGE_ARROWTOWER + (PLUS_ATTACK_ARROWTOWER_BY_TECHNOLOGY * baseDamage) * 1000/100;
        super.experience = 0;
