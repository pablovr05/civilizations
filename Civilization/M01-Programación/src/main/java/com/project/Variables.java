...
public interface Variables {
    ...
    public final int CIVILIZATION_MANA_GENERATED_PER_MAGIC_TOWER = 100;
    // TECHNOLOGY COST
    ...
    public final int UPGRADE_PLUS_DEFENSE_TECHNOLOGY_WOOD_COST = 30;
    public final int UPGRADE_PLUS_ATTACK_TECHNOLOGY_WOOD_COST = 30;
