...
public class TecnologíasFrame extends JPanel {
    ...
    // Variables de instancia para los labels de los materiales
    private JLabel material1;
    private JLabel material2;
    private JLabel material3;
    private JLabel material4;
    private JLabel material5;
    private JLabel material6;

    private int nivelDefensa;
    private int nivelAtaque;

    public JLabel titleLeft;
    public JLabel titleRight;

    public TecnologíasFrame() {

        int[] costes = CivilizaciónControlador.civilización.getUpgradeMaterials();

        this.comida1 = costes[0];
        this.madera1 = costes[1];
        this.hierro1 = costes[2];
        this.comida2 = costes[3];
        this.madera2 = costes[4];
        this.hierro2 = costes[5];

        this.nivelDefensa = CivilizaciónControlador.civilización.technologyDefense;
        this.nivelAtaque = CivilizaciónControlador.civilización.technologyAttack;
        ...
        titleLeft = new JLabel("Ataque: " + nivelAtaque);
        titleLeft.setFont(new Font("Reem Kufi", Font.BOLD, 16));
        titleLeft.setForeground(Color.WHITE);
        leftPanel.add(titleLeft);

        material1 = createLabelWithImage(String.valueOf(comida1), "src\\main\\java\\com\\project\\images\\naranja.png");
        TooltipHelper.setCustomTooltip(material1, "Cantidad de comida necesaria para mejorar el ataque");
        material2 = createLabelWithImage(String.valueOf(madera1), "src\\main\\java\\com\\project\\images\\madera.png");
        TooltipHelper.setCustomTooltip(material2, "Cantidad de madera necesaria para mejorar el ataque");
        material3 = createLabelWithImage(String.valueOf(hierro1), "src\\main\\java\\com\\project\\images\\minerals.png");
        ...
        titleRight = new JLabel("Defensa: " + nivelDefensa);
        titleRight.setFont(new Font("Reem Kufi", Font.BOLD, 16));
        titleRight.setForeground(Color.WHITE);
        rightPanel.add(titleRight);

        material4 = createLabelWithImage(String.valueOf(comida2), "src\\main\\java\\com\\project\\images\\naranja.png");
        TooltipHelper.setCustomTooltip(material4, "Cantidad de comida necesaria para mejorar la defensa");
        material5 = createLabelWithImage(String.valueOf(madera2), "src\\main\\java\\com\\project\\images\\madera.png");
        TooltipHelper.setCustomTooltip(material5, "Cantidad de madera necesaria para mejorar la defensa");
        material6 = createLabelWithImage(String.valueOf(hierro2), "src\\main\\java\\com\\project\\images\\minerals.png");
        ...
        actualizarColorLabel(material1, comida1, CivilizaciónControlador.civilización.food);
        actualizarColorLabel(material2, madera1, CivilizaciónControlador.civilización.wood);
        actualizarColorLabel(material3, hierro1, CivilizaciónControlador.civilización.iron);

        actualizarColorLabel(material4, comida2, CivilizaciónControlador.civilización.food);
        actualizarColorLabel(material5, madera2, CivilizaciónControlador.civilización.wood);
        actualizarColorLabel(material6, hierro2, CivilizaciónControlador.civilización.iron);
    }
    ...
    // Método para actualizar los valores de los labels de los materiales
    public void actualizarLabels(int[] costes) {
        this.comida1 = costes[0];
        this.madera1 = costes[1];
        this.hierro1 = costes[2];
        this.comida2 = costes[3];
        ...
        material1.setText(String.valueOf(comida1));
        material2.setText(String.valueOf(madera1));
        material3.setText(String.valueOf(hierro1));
        material4.setText(String.valueOf(comida2));
        material5.setText(String.valueOf(madera2));
        material6.setText(String.valueOf(hierro2));

        // Verificar y actualizar el color de los materiales de ataque
        actualizarColorLabel(material1, comida1, CivilizaciónControlador.civilización.food);
        actualizarColorLabel(material2, madera1, CivilizaciónControlador.civilización.wood);
        actualizarColorLabel(material3, hierro1, CivilizaciónControlador.civilización.iron);

        // Verificar y actualizar el color de los materiales de defensa
        actualizarColorLabel(material4, comida2, CivilizaciónControlador.civilización.food);
        actualizarColorLabel(material5, madera2, CivilizaciónControlador.civilización.wood);
        actualizarColorLabel(material6, hierro2, CivilizaciónControlador.civilización.iron);
    ...
    private void actualizarColorLabel(JLabel label, int required, int available) {
